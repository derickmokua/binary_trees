...
/**
 * heap_to_sorted_array - transforms a Binary Max Heap to a sorted integer array
 * @heap: a pointer to the root node of the heap to be transformed
 * @size: a pointer to store the size of the generated array
 *
